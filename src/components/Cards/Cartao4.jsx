  ...
  function handlePlayerCarregar(e) {
    ...
    api
      ...
      .then(res => {
        ...
        document.getElementById("Classe4").value = res.data.classe;
        document.getElementById("Arrombscoin4").value = res.data.arrombscoin;
        document.getElementById("ExperienciaAtual4").value =
          res.data.experienciaAtual;
        document.getElementById("ExperienciaProximoNivel4").value =
          res.data.experienciaProximoNivel;
        document.getElementById("HpAtual4").value = res.data.vidaAtual;
        document.getElementById("HpTotal4").value = res.data.vidaTotal;
        document.getElementById("MpAtual4").value = res.data.manaAtual;
        document.getElementById("MpTotal4").value = res.data.manaTotal;
        document.getElementById("Ataque4").value = res.data.ataque;
        document.getElementById("Defesa4").value = res.data.defesa;
        document.getElementById("Inteligencia4").value = res.data.inteligencia;
        document.getElementById("Resistencia4").value = res.data.resistencia;
        document.getElementById("Previsao4").value = res.data.previsao;
        document.getElementById("Velocidade4").value = res.data.velocidade;
