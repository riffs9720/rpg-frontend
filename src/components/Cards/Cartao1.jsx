  ...
  function handlePlayerCarregar(e) {
    ...
    api
      ...
      .then(res => {
        ...
        document.getElementById("Classe").value = res.data.classe;
        document.getElementById("Arrombscoin").value = res.data.arrombscoin;
        document.getElementById("ExperienciaAtual").value =
          res.data.experienciaAtual;
        document.getElementById("ExperienciaProximoNivel").value =
          res.data.experienciaProximoNivel;
        document.getElementById("HpAtual").value = res.data.vidaAtual;
        document.getElementById("HpTotal").value = res.data.vidaTotal;
        document.getElementById("MpAtual").value = res.data.manaAtual;
        document.getElementById("MpTotal").value = res.data.manaTotal;
        document.getElementById("Ataque").value = res.data.ataque;
        document.getElementById("Defesa").value = res.data.defesa;
        document.getElementById("Inteligencia").value = res.data.inteligencia;
        document.getElementById("Resistencia").value = res.data.resistencia;
        document.getElementById("Previsao").value = res.data.previsao;
        document.getElementById("Velocidade").value = res.data.velocidade;
