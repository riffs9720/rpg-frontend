...
export default function Cartao6() {
  ...
  function handlePlayerCarregar(e) {
    ...
    api
      .get("/player/7")
      .then(res => {
        document.getElementById("Nome6").value = res.data.nome;
        document.getElementById("Raca6").value = res.data.raca;
        document.getElementById("Classe6").value = res.data.classe;
        document.getElementById("Arrombscoin6").value = res.data.arrombscoin;
        document.getElementById("ExperienciaAtual6").value =
          res.data.experienciaAtual;
        document.getElementById("ExperienciaProximoNivel6").value =
          res.data.experienciaProximoNivel;
        document.getElementById("HpAtual6").value = res.data.vidaAtual;
        document.getElementById("HpTotal6").value = res.data.vidaTotal;
        document.getElementById("MpAtual6").value = res.data.manaAtual;
        document.getElementById("MpTotal6").value = res.data.manaTotal;
        document.getElementById("Ataque6").value = res.data.ataque;
        document.getElementById("Defesa6").value = res.data.defesa;
        document.getElementById("Inteligencia6").value = res.data.inteligencia;
        document.getElementById("Resistencia6").value = res.data.resistencia;
        document.getElementById("Previsao6").value = res.data.previsao;
        document.getElementById("Velocidade6").value = res.data.velocidade;
