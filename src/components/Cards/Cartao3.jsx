...
export default function Cartao3() {
  ...
  function handlePlayerCarregar(e) {
    ...
    api
      .get("/player/4")
      .then(res => {
        document.getElementById("Nome3").value = res.data.nome
        document.getElementById("Raca3").value = res.data.raca
        document.getElementById("Classe3").value = res.data.classe
        document.getElementById("Arrombscoin3").value = res.data.arrombscoin
        document.getElementById("ExperienciaAtual3").value = res.data.experienciaAtual
        document.getElementById("ExperienciaProximoNivel3").value = res.data.experienciaProximoNivel
        document.getElementById("HpAtual3").value = res.data.vidaAtual
        document.getElementById("HpTotal3").value = res.data.vidaTotal
        document.getElementById("MpAtual3").value = res.data.manaAtual
        document.getElementById("MpTotal3").value = res.data.manaTotal
        document.getElementById("Ataque3").value = res.data.ataque
        document.getElementById("Defesa3").value = res.data.defesa
        document.getElementById("Inteligencia3").value = res.data.inteligencia
        document.getElementById("Resistencia3").value = res.data.resistencia
        document.getElementById("Previsao3").value = res.data.previsao
        document.getElementById("Velocidade3").value = res.data.velocidade
          ...
          <Tabs defaultActiveKey="Info do Player" id="uncontrolled-tab-example">
            <Tab eventKey="Info do Player" title="Info do Player">
              <div className="linha1">
                <TextField id="Nome3" label="Nome" variant="filled" name="Nome"
                InputProps={{ className: "estiloInfoPlayer" }}
                InputLabelProps={{ className: "estiloInfoPlayer", shrink: true  }}
                onChange={e => setNome(e.target.value)}
                />
                <div className="espacamento" />
                <TextField id="Raca3" label="Raca" variant="filled" 
                InputProps={{ className: "estiloInfoPlayer" }}
                InputLabelProps={{ className: "estiloInfoPlayer" , shrink: true }}
              ...
              <div className="linha2">
                <TextField id="Classe3" label="Classe" variant="filled" 
                InputProps={{ className: "estiloInfoPlayer" }}
                InputLabelProps={{ className: "estiloInfoPlayer" , shrink: true }}
              ...
              <CardActions>
          <Button type="submit" className="atualizarPlayer">Atualizar Player</Button>
          <Button type="button" className="carregarPlayer" onClick={handlePlayerCarregar}>Carregar Player</Button>
        </CardActions>
            </Tab>
            ...
            <p>Atributos Padrões</p>
              ...
              <div className="linha1">
                ...
                <TextField
                    ...
                    variant="outlined"
                    type="number"
                    InputProps={{ readOnly: true, className: "estiloInfoPlayer" }}
                    InputLabelProps={{ className: "estiloInfoPlayer", shrink: true }}
                  />
                  <div className="espacamento" />
                  <TextField
