  ...
  function handlePlayerCarregar(e) {
    ...
    api
      ...
      .then(res => {
        ...
        document.getElementById("Classe2").value = res.data.classe
        document.getElementById("Arrombscoin2").value = res.data.arrombscoin
        document.getElementById("ExperienciaAtual2").value = res.data.experienciaAtual
        document.getElementById("ExperienciaProximoNivel2").value = res.data.experienciaProximoNivel
        document.getElementById("HpAtual2").value = res.data.vidaAtual
        document.getElementById("HpTotal2").value = res.data.vidaTotal
        document.getElementById("MpAtual2").value = res.data.manaAtual
        document.getElementById("MpTotal2").value = res.data.manaTotal
        document.getElementById("Ataque2").value = res.data.ataque
        document.getElementById("Defesa2").value = res.data.defesa
        document.getElementById("Inteligencia2").value = res.data.inteligencia
        document.getElementById("Resistencia2").value = res.data.resistencia
        document.getElementById("Previsao2").value = res.data.previsao
        document.getElementById("Velocidade2").value = res.data.velocidade
          ...
          <Tabs defaultActiveKey="Info do Player" id="uncontrolled-tab-example">
            <Tab eventKey="Info do Player" title="Info do Player">
              ...
              <div className="linha2">
                <TextField id="Classe2" label="Classe" variant="filled" 
                InputProps={{ className: "estiloInfoPlayer" }}
                InputLabelProps={{ className: "estiloInfoPlayer" , shrink: true }}
